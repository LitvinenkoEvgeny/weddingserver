  ...
  '<div class="pop-up review">',
     '<h3>Благодарность</h3>',
  	...
  	'<div id="show-review-nav">',
  		'<a class="prev" data-remote="true" href="reviews/3/index.js"></a>',
  		'<a class="next" data-remote="true" href="reviews/5/index.js"></a>',
  	'</div>',
		'<img alt="" class="photo" src="reviews/4/4.jpg">',
  	'<p class="text">Любой текст</p>',
  	'<p class="date"><img src="date.svg">10 октября 2015</p>',
  '</div>'
].join('\n'));
