...
$("#show-review").removeClass('hidden').children('.handle').html([
  '<div class="pop-up review">',
    ...
    // ПРЕД/СЛЕД
  		'<a class="prev" data-remote="true" href="reviews/7/index.js"></a>',
  		'<a class="next" data-remote="true" href="reviews/9/index.js"></a>',
  	'</div>',
    // КАРТИНКА
		'<img alt="" class="photo" src="reviews/8/8.jpg">',
  	'<p class="text">Любой текст</p>',
    // ДАТА
  	'<p class="date"><img src="date.svg">09 декабря 2016</p>',
  '</div>'
].join('\n'));
