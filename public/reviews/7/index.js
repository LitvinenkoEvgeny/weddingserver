...
$("#show-review").removeClass('hidden').children('.handle').html([
  '<div class="pop-up review">',
    ...
    // ПРЕД/СЛЕД
  		'<a class="prev" data-remote="true" href="reviews/6/index.js"></a>',
  		'<a class="next" data-remote="true" href="reviews/8/index.js"></a>',
  	'</div>',
    // КАРТИНКА
		'<img alt="" class="photo" src="reviews/7/7.jpg">',
  	'<p class="text">Любой текст</p>',
    // ДАТА
  	'<p class="date"><img src="date.svg">27 ноября 2015</p>',
  '</div>'
].join('\n'));
